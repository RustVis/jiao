...
cfg_if::cfg_if! {
    ...
    } else if #[cfg(feature = "cairo")] {
        pub mod cr;
        pub type PaintContext = cr::paint_context::PaintContext;
        pub type PaintDevice = cr::paint_device::PaintDevice;
        pub type Painter = cr::painter::Painter;
        pub type Path = cr::painter::Path;
    }
}
