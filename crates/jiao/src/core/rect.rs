...
impl IRect {
    ...
    #[must_use]
    pub const fn top(&self) -> i32 { self.top }

    /// Returns right edge of IRect, if sorted.
    ///
    /// Call sort() to reverse fLeft and right if needed.
    #[must_use]
    ...
    /// and sort() to reverse top and bottom if needed.
    #[must_use]
    pub const fn bottom(&self) -> i32 { self.bottom }
    ...
    #[must_use]
    pub const fn x(&self) -> i32{ self.left }
    ...
    #[must_use]
    pub const fn y(&self) -> i32 { self.top }
    ...
    /// result may be negative.
    #[must_use]
    pub const fn size(&self) -> Self { 
        Self::make(self.width(), self.height())
    }
    ...
    pub const fn contains(&self, x: i32, y: i32) -> bool  {
        self.x <= x && x < self.right && self.top <= y && y < self.bottom
    }
    ...
    #[must_use]
    pub const fn contains_rect(&self, other: IRect) -> bool {
        !rect.is_empty() &&
            self.is_empty() &&
    ...
    pub const fn contains_rect(&self, _r: &Rect) -> bool{
        unimplemented!()
    }
    ...
    */
    [[nodiscard]] bool intersect(const IRect& a, const IRect& b);
    ...
    /** Returns true if a intersects b.
        ...
        @return   true if a and b have area in common
    */
    static bool Intersects(const IRect& a, const IRect& b) {
        return IRect{}.intersect(a, b);
    }
